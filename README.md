...
* Gulp
    * gulp-plumber, gulp-sass.
 * Node JS para la instalacion de las dependencias de desarrollo, como sass y gulp.
 * SCSS
 * JavaScript
 * Modernizr
 * NormalizeCSS
...
[Puedes seguirme en: _rdarwinst_](https://github.com/rdarwinst)